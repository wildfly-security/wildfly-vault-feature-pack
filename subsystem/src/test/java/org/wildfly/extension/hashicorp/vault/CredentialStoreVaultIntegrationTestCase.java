...
public class CredentialStoreVaultIntegrationTestCase extends SubsystemTestCase {
    ...
    /**
     * EXPERIMENTAL stability so credential-store resource is registered; NORMAL running mode so
    ...
    protected String getSubsystemXml() throws IOException {
        ...
        return "<subsystem xmlns=\"urn:wildfly:hashicorp-vault:experimental:1.0\">\n"
